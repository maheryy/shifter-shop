        ...
        <div className="grid gap-16">
          <div className="grid gap-8">
            <div className="grid gap-4">
              ...
              <p>
                Having your e-mail and account set up is a great starting point.
              </p>
            </div>
            <div className="grid gap-4">
              <h2 className="text-lg font-bold md:text-2xl md:font-medium">
              ...
              <p>Tell us about your business and how can we work together.</p>
            </div>
            <div className="grid gap-4">
              <h2 className="text-lg font-bold md:text-2xl md:font-medium">
              ...
              <p>
                In order to ensure a secure and reliable environment we’ll get
                back to you to establish trust between us.
              </p>
            </div>
            <div className="grid gap-4">
              <h2 className="text-lg font-bold md:text-2xl md:font-medium">
